...
function renderArtifactLinks(options: DashboardRenderOptions): string {
  return [
    ...
    { href: `${options.reportBase}learnings/README.md`, text: "Agent learnings README" },
    { href: `${options.reportBase}learnings/agent-learning-template.md`, text: "Agent learning template" },
    { href: `${options.reportBase}learnings/run-retrospective.json`, text: "Run retrospective" },
